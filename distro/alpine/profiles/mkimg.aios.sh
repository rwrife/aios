...
profile_aios() {
	...
	# bundled Qwen model need more than 3 GiB in a 4 GiB live VM; this is a
	# ceiling, not an up-front allocation. Installed ext4 systems do not use it.
	kernel_cmdline="console=tty0 console=ttyS0,115200 loglevel=4 rootflags=size=90%"
