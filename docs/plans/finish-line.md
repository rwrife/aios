...
| T15 Agent browser | Chromium in the shared per-chat tool host, bounded structured tool loop | Real tool-capable model/provider matrix, broader websites and embedded-browser UI |
