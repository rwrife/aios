...
The optional `AIOS_IDENTITY_BUILD=1` image now uses Alpine's supported `mousepad`
package for protected workspace editing. The boot verification above used the
