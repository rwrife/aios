...
- **AI models:** shared with chat's ellipsis menu. Choose a local GGUF or starter
  download, or configure a compatible remote endpoint, model and API key. The
...
- **Appearance:** enables or reduces background motion.
